...
class ProgramaPrincipal:
    ...
    def main(self):
        while True:
            ...
            print("5. Ordenar lista con heap sort")
            print("6. Ordenar lista con merge sort")
            print("7. Aplicar algoritmo de Dijkstra")
            print("8. Aplicar algoritmo de Floyd-Warshall")
            print("9. Salir")
